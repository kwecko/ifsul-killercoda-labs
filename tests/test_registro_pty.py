...
def main():
    ...
    install -m 644 /lab/usuarios-grupos/assets/laboratorio.sh /lab/usuarios-grupos/assets/laboratorio.conf /usr/local/lib/laboratorio/
    ...
    try:
        ...
        send('000000000')
        wait_for(b'Informe seu nome completo: ')
        send('José da Silva')
        wait_for(b'# ')
